                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <div class="title_right" >
                            ...
                            <a href="<?php echo base_url('attendance/mark_attendance'); ?>"><button type="button" class="btn btn-success btn-m" >Mark Attendance</button></a>
                            </div>
                  </div>
...
function change_month()
        {
            month = document.getElementById("month").value;
                if(month != '')
                window.location.href = "<?php echo base_url('attendance/attendance_status/'.date('Y').'/');?>"+month+"";
        }
        </script>