                      ...
                      <tbody>
                        ...
                        foreach ($leaves as $leave) {
                          ...
                          <td data-title="<?=$this->lang->line('slno')?>">
                              ...
                              <a href="hod_leave_update/<?php echo $leave->leave_id; ?>"><button type="button" class="btn btn-info btn-sm">View</button></a>
                              <?php }?>
                                    </td>                        
                          </tr>
                        <?php
