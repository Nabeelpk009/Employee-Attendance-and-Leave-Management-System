                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                      ...
                      <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="no_of_days">Type of Leave<span class="readonly">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" readonly="readonly" class="form-control " value="<?php echo $leave->leave_name_full; ?>" readonly>
                          <input type="hidden" id="leave_type" name="leave_type" readonly="readonly" class="form-control " value="<?php echo $leave->leavetype_id ; ?>" readonly>
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <textarea name="reason" id="reason" class="form-control"  readonly><?php echo $leave->reason; ?></textarea>
                        </div>
                      </div>
                      
                      <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="hod_remarks">Remarks <span class="readonly">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                          <textarea name="hod_remarks" id="hod_remarks" class="form-control" placeholder="Enter the Remarks" required></textarea>
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="hod_status">Action <span class="readonly">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                            <select name="hod_status" id="hod_status" class="form-control" required>
