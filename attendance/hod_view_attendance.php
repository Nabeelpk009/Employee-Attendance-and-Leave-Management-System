...
<div class="right_col" role="main">
                  ...
                  <div class="x_content" style="overflow-x:scroll;">
                      ...
                      <?php 
                        ...
                        foreach ($users as $user) {
                          ...
                          ?>
                          <tr align="center">
                          <form id="hod_view_attendance"  action="<?php echo base_url('attendance/hod_view_attendance');?>" method="post">
                          ...
                          <td data-title="<?=$this->lang->line('slno')?>">
                            ...
                            <td data-title="Remarks">
                                    ...
                                    <textarea name="approval_remarks" id="approval_remarks" style="width:250px; height:80px;" class="form-control" placeholder="Enter the Remarks"></textarea>
                                    </div>
                                <td data-title="Last Updated On">
                                        <?php echo $user['approval_timestamp']; ?>
                                </td>
                                <td data-title="Actions">
                                <?php if($user['hod_approval_status']==0) {?>
                                <center>
                                <button type="submit" value="1" id="submit" class="btn btn-info"> Approve </button>
                                </center>
                                <?php }?>
                                <?php if($user['hod_approval_status']==1){
                               
                                echo"<span style='color:green; font-size: 15px;'>Approved</span>";
                                ?>
                                <?php }?>
                                </td>
                            </form>
        ...
        function change_month()
        {
            month = document.getElementById("month").value;
                if(month != '')
                window.location.href = "<?php echo base_url('attendance/hod_view_attendance/'.date('Y').'/');?>"+month+"";
        }
