                          ...
                          <td data-title="<?=$this->lang->line('slno')?>">
                                    ...
                                    <td data-title="Current Status" style="white-space: nowrap;">
                                        ...
                                        if($leave->hod_status==0)
                                            ...
                                            echo"<span style='color:orange;'>Pending Approval From HR </span>";
                                        else if($leave->hr_status==1 && $leave->hod_status>=1 )
                                    ...
                                    <td data-title="HOD Name" style="white-space: nowrap;">
                                        <?php echo $leave->approval_name; ?>
                                    </td> 
                                    ...
                                    <?php if($leave->hr_status==0 && $leave->hod_status>0 ) {?>
